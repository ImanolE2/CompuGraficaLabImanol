...
int main( )
{
    ...
    // Load models
    Model dog((char*)"Models/RedDog.obj"); //Carga modelo
    Model gato((char*)"Models/miGato.obj"); //Carga modelo
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 model(1);
        model = glm::translate(model, glm::vec3(0.0, 0.0f, 0.0f)); //Desplazamos el modelo 20 unidades en el eje x, para dibujar al segundo  gato
