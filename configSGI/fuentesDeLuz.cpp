...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (GLuint i = 0; i < 4; i++)
		{
			...
			//Dibujar los colores de las lamparas
			glm::vec3 lampColor; 
			if (i == 0) lampColor = glm::vec3(1.0f, 1.0f, 0.0f); //luz 1 color amarillo
			else if(i == 1) lampColor = glm::vec3(1.0f, 0.0f, 0.0f); //luz 2 color rojo
			else if (i == 2) lampColor = glm::vec3(0.0f, 1.0f, 0.0f); //luz 3 color verde
			else lampColor = glm::vec3(0.0f, 0.0f, 1.0f); //luz azul
